<template>
  <button
    ...
    class="relative overflow-hidden flex flex-col bg-dark-900 rounded-lg shadow-gray-400 shadow-xl px-6 py-4 transform transition-all hover:(bg-dark-800 scale-105)"
  >
    <h2
      :id="data.name"
      class="flex w-full justify-between text-lg sm:text-2xl font-medium mb-2"
    >
    ...
    <div class="flex justify-between items-center">
      <p
        class="capitalize px-3 py-1 rounded text-black font-medium"
  ...
  <TransitionRoot as="template" :show="open">
    ...
    >
      <div
        class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center block"
      >
        <TransitionChild
          as="template"
